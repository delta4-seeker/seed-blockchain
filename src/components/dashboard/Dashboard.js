      ...
      <div className="flex w-full">
        <div className="flex flex-col justify-center bg-gray-50 items-center  py-5  w-full">
          ...
          <div className="  lg:h-96 flex w-max justify-start  flex-col mt-[-10px] ">
            <div>
              <button className=" outline-none h-14 rounded-md py-4 px-4 mb-5 bg-green-900 text-white font-semi-bold ">
                {" "}
                Show Transactions
              </button>
            </div>
                    ...
                    {rows.map((row, i) => (
                      ...
                      >
                        ...
                        <TableCell align="center" className="text-blue">
                          <h1 className="bg-green-500 mx-auto w-max py-3 px-5 rounded-xl text-center text-white">
                            {" "}
                            {row.fat}
                          </h1>
                        </TableCell>
