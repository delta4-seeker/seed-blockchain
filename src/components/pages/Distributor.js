      ...
      <div className="flex flex-col justify-center w-3/4 mx-auto items-start py-10  bg-gray-50">
        <div className="border border-gray-300 flex flex-col justify-center  bg-white shadow-lg w-full mx-auto p-5 rounded-xl">
          <div>
            <input
              type="text"
              className="border border-gray-300 px-2 py-4  w-full rounded-md focus:outline-none focus:ring focus:border-green-500  "
          ...
          <div>
            <input
              type="number"
              className="border border-gray-300 px-2 py-4  mt-2  w-full rounded-md focus:outline-none focus:ring focus:border-green-500  "
        ...
        <div>
          <button className=" outline-none mt-10 rounded-md flex w-full px-10 py-4 bg-green-900 text-white font-semi-bold ">
            {" "}
            Show Transcactions
          </button>
        </div>
