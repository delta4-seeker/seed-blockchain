...
import logo from "../image/path300.png" ; 
const NavBar = () => {
  ...
  return (
    <>
      ...
      <div
        data-navbar
        className={` 
       z-[1000] w-full   navbar    text-white  bg-green-700 flex justify-between items-center   sticky top-0 `}
      >
        <nav className="flex relative  w-full  py-3  justify-center px-8  items-center  backdrop-blur-lg  md:bg-opacity-20 shadow text-center">
          <div className="flex justify-between  items-center w-full ">
            ...
            <ul className="hidden lg:flex justify-center items-center font-nav text-md text-black space-x-4 ">
              {AllLinks.map((link) => (
                <li key={link.id}>
                  <NavLink
                    className=" border-b-2  border-transparent hover:border-dorange text-white "
                    style={({ isActive }) => {
                      return {
                        padding: "6px",
